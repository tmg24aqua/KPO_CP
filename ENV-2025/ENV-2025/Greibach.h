// Greibach.h - Грамматика в нормальной форме Грейбах
//
// Грамматика в нормальной форме Грейбах используется для синтаксического анализа.
// В нормальной форме Грейбах каждое правило имеет вид: A -> aB1B2...Bn,
// где A - нетерминал, a - терминал, B1...Bn - нетерминалы.
//
// Основные компоненты:
// - Rule: правило грамматики (нетерминал -> цепочка терминалов и нетерминалов)
// - Chain: цепочка (правая часть правила)
// - Greibach: грамматика (набор правил)
...
namespace GRB
{
	...
	// Имеет вид: нетерминал -> цепочка1 | цепочка2 | ...
	struct Rule
	{
