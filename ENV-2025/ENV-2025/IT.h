// IT.h - Таблица идентификаторов
//
// Таблица идентификаторов хранит информацию о всех идентификаторах программы:
// - Переменные (V)
// - Функции (F)
// - Параметры функций (P)
// - Литералы (L) - числа, строки, символы
// - Стандартные функции (S) - compare, length и т.д.
//
// Для каждого идентификатора хранится:
// - Имя
// - Тип данных (INT, SYM, STR)
// - Тип идентификатора (переменная, функция и т.d.)
// - Значение (для литералов)
// - Информация о параметрах (для функций)

#pragma once
#include"pch.h"
#define ID_MAXSIZE	20					 // Максимальное число символов идентификатора (8 по спецификации)
