// In.h - Модуль ввода и предобработки исходного кода
//
// Модуль выполняет:
// 1. Чтение исходного файла
// 2. Классификацию символов (буквы, цифры, операторы, разделители и т.д.)
// 3. Разбиение текста на слова (лексемы) с сохранением номеров строк
// 4. Проверку допустимых символов для языка ENV-2025
//
// Классификация символов:
// - L: Буквы (A-Z, a-z) - для идентификаторов
// - D: Цифры (0-9) - для чисел
// - H: Шестнадцатеричные цифры (A-F, a-f)
// - O: Операторы (+, -, *, /, %, =)
// - S: Разделители (;, ,, (, ), {, }, [, ])
// - Q: Строковые литералы (")
// - A: Символьные литералы (')
// - W: Пробельные символы
// - I: Запрещённые символы
