...
{
	/*
	  Грамматика языка в форме Грейбах для нисходящего разбора.
	  S - начальный символ (структура программы).
	  K - операторы и выражения.
	  E - выражения.
	*/
...
Rule(NS('W'), GRB_ERROR_SERIES + 11, 14,
	Rule::Chain(1, TS('i')),
	Rule::Chain(1, TS('l')),
	...
	Rule::Chain(3, TS('-'), TS('l'), NS('A'), NS('W')),
...
Rule(NS('K'), GRB_ERROR_SERIES + 12, 22,
	...
	Rule::Chain(5, TS('i'), TS(':'), NS('V'), TS(';'), NS('K')),
	...
	Rule::Chain(6, TS('R'), NS('V'), TS('T'), TS('d'), NS('H'), NS('K')),
	...
	Rule::Chain(5, TS('R'), NS('V'), TS('T'), TS('d'), NS('H')),
	Rule::Chain(5, TS('R'), NS('V'), TS('T'), TS('d'), NS('H')),
...
Rule(NS('X'), GRB_ERROR_SERIES + 13, 12,
	...
	Rule::Chain(5, TS('i'), TS(':'), NS('V'), TS(';'), NS('X')),
...
Rule(NS('H'), GRB_ERROR_SERIES + 17, 3,	
