...
#define GRAPH_CHAR_LITERAL 4,\
	...
	FST::NODE(96, \
			...
			FST::RELATION('}', 2), FST::RELATION('{', 2), FST::RELATION(']', 2), FST::RELATION('[', 2),\
			FST::RELATION('!', 2), FST::RELATION('?', 2), FST::RELATION('#', 2), FST::RELATION('&', 2),\
			FST::RELATION('>', 2), FST::RELATION('<', 2), FST::RELATION('%', 2), FST::RELATION('_', 2),\
			FST::RELATION('~', 2)),\
	FST::NODE(1, FST::RELATION('\'', 3)), \
	FST::NODE()

#define GRAPH_INTEGER_LITERAL 5, \
	FST::NODE(11, \
			FST::RELATION('0', 1), FST::RELATION('1', 2), FST::RELATION('2', 2), FST::RELATION('3', 2),\
			FST::RELATION('4', 2), FST::RELATION('5', 2), FST::RELATION('6', 2), FST::RELATION('7', 2),\
			FST::RELATION('8', 2), FST::RELATION('9', 2), FST::RELATION('-', 3)),\
	FST::NODE(1, FST::RELATION('x', 4)),\
	FST::NODE(11, \
			FST::RELATION('0', 2), FST::RELATION('1', 2), FST::RELATION('2', 2), FST::RELATION('3', 2),\
			FST::RELATION('4', 2), FST::RELATION('5', 2), FST::RELATION('6', 2), FST::RELATION('7', 2),\
			FST::RELATION('8', 2), FST::RELATION('9', 2), FST::RELATION('b', 4)),\
	FST::NODE(22, \
			...
			FST::RELATION('8', 4), FST::RELATION('9', 4), FST::RELATION('a', 4), FST::RELATION('b', 4),\
			FST::RELATION('c', 4), FST::RELATION('d', 4), FST::RELATION('e', 4), FST::RELATION('f', 4),\
			FST::RELATION('A', 4), FST::RELATION('B', 4), FST::RELATION('C', 4), FST::RELATION('D', 4),\
			FST::RELATION('E', 4), FST::RELATION('F', 4)),\
	FST::NODE()

#define GRAPH_BINARY_LITERAL 4, \
