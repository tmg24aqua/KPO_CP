// Greibach.cpp - Реализация грамматики в нормальной форме Грейбах
//
// Содержит функции для работы с грамматикой:
// - Создание правил и цепочек
// - Поиск правил по нетерминалу
// - Получение подходящих цепочек правил
// - Преобразование символов грамматики в строки для отладки
